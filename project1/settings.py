...
DEFAULT_AUTO_FIELD = 'django.db.models.BigAutoField' and this is my url.py from django.urls import path
from . import views
...
if settings.DEBUG:
    urlpatterns += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) .the images are in data.js
